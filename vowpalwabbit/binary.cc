...
VW::LEARNER::base_learner* binary_setup(setup_base_fn& setup_base)
{
  ...
  auto ret = VW::LEARNER::make_no_data_reduction_learner(
      as_singleline(setup_base()), predict_or_learn<true>, predict_or_learn<false>, all.get_setupfn_name(binary_setup))
